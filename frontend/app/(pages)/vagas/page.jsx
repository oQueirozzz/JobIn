            ...
            vagasFiltradas.map((vaga) => (
              ...
              >
                ...
                <div className="flex flex-wrap pt-2 text-gray-700 text-xl gap-2">
                  <span className='text-xl'>{vaga.local_vaga}</span>
                  <span className="text-[#7B2D26]">|</span>
                  <span>{vaga.tipo_vaga}</span>
                </div>
                <div className="flex pt-2 text-gray-700 text-sm">
                  Área - <span className="pl-2 text-sm">{vaga.categoria}</span>
                </div>

                <div>
                  <span className='text-gray-700 text-sm'>
                    {vaga.descricao.length > 100 ? vaga.descricao.slice(0, 100) + '...' : vaga.descricao}
                  </span>
                </div>

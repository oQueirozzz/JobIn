...
export default function Vagas() {
  ...
  // Para filtro futuro, poderia filtrar o array vagas aqui, por enquanto só usa todos
  ...
  return (
    <section className="bg-gray-50 flex flex-col items-center min-h-screen">
      ...
      <div className="h-auto flex flex-col-reverse lg:flex-row justify-center w-full px-4 md:px-10 mt-8 gap-6">
            ...
            vagas.map((vaga) => (
              ...
              >
                ...
                <button
                  ...
                  type="button"
                  onClick={(e) => {
                    e.stopPropagation(); // para não disparar o onClick do card
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-6 lg:mt-0 lg:ml-6 relative lg:sticky lg:top-20 self-start">
          {vagaSelecionada ? (
            <>
              ...
              <button
                ...
                type="button"
                // Aqui poderia ter a lógica para se candidatar, etc.
              >
                Candidatar-me
              </button>
            </>

...
export default function config() {
    return (
        <section className="min-h-screen bg-gray-50 flex  justify-center p-20  ">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 w-8/12 h-full flex flex-col ">

                {/*Header */}
                <div className=" h-2/12 rounded-tr-xl rounded-tl-xl border-b border-b-gray-200 flex items-center justify-between p-5">
                    <h1 className="text-xl font-bold">Configurações</h1>
                    <svg width="100" height="40" viewBox="0 0 830 330" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/*Alterar senha*/}
                <Link rel="stylesheet" href="/novaSenha" className="w-full h-3/12 border-b border-b-gray-100 p-5 flex items-center hover:bg-gray-50 " >
                    <h1 className="font-bold">Redefinir Senha</h1>
                </Link>


                {/*Notificações*/}
                <div className="w-full h-3/12 border-b border-b-gray-100 p-5 flex items-center justify-between">
        ...
        peer-hover:after:scale-95">
                ...
                <div className="w-full h-3/12 border-b border-b-gray-100 p-5 flex items-center justify-between">
                    ...
                    <button type="button" className="w-full h-10 md:w-auto px-8 py-4 bg-[#7B2D26] text-white rounded-xl font-normal shadow-lg shadow-[#7B2D26]/20 hover:bg-[#9B3D36] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7B2D26] transition-all duration-300 flex items-center justify-center cursor-pointer">Excluir</button>
                </div>
            </div>
        </section>
    )

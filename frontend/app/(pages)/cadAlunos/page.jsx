export default function cadAlunos() {
    return (
        <section className="w-full min-h-screen flex items-center justify-center px-4 bg-branco">
            <div className="w-[600px] bg-white rounded-lg shadow-xl p-10 m-20">
                ...
                <form className="w-full" id="cadastroForm">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <textarea name="habilidades" id="habilidades" rows="3" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent resize-none border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-vinho peer" placeholder=" " required></textarea>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <textarea name="descricao" id="descricao" rows="3" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent resize-none border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-vinho peer" placeholder=" " required></textarea>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <label htmlFor="curriculo" className="block mb-2 text-sm font-medium text-gray-600">Currículo
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <label htmlFor="foto" className="block mb-2 text-sm font-medium text-gray-600">Foto
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <label htmlFor="certificados" className="block mb-2 text-sm font-medium text-gray-600">Certificados
                            <span className="text-gray-400">(PDF, ZIP, etc.)</span>
                        </label>
